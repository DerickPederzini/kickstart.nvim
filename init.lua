...
vim.keymap.set('n', '<leader>k', '<cmd>lnext<CR>zz') -- next location list
vim.keymap.set('n', '<leader>j', '<cmd>lprev<CR>zz') -- prev location list
...

  {
    ...
    config = function()
      require('nvim-treesitter.configs').setup {
        ...
        indent = { enable = true },
        ensure_installed = { 'lua', 'vim', 'javascript', 'rust', 'go', 'typescript', 'c', 'python' },
      }
    end,
  },
